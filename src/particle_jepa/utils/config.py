    ...
    if "project" in config:
        ...
        return {
            ...
            "model": {
                ...
                "predictor_type": model.get("predictor_type", "message_passing"),
                "predictor_layers": model.get("predictor_layers"),
                "predictor_heads": model.get("predictor_heads", 4),
                "predictor_dropout": model.get("predictor_dropout"),
            },
            "train": {
                ...
                "preflight_batches": training.get("preflight_batches", 0),
                "preflight_min_batches_per_second": training.get(
